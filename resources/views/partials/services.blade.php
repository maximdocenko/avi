    ...
    <div class="container">
                ...
                <div class="card">
                        <div class="icon">
                            <a href="{{ url('services', $doctor->id) }}">
                                <img class="card-img-top" src="{{url('assets/images', $doctor->image)}}" alt="{{$doctor->title}}">
                            </a>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-sm-4 col-xs-6 avi-col">
                <div class="card">
                        <div class="icon">
                            <a href="{{ url('services', $legal->id) }}">
                                <img class="card-img-top" src="{{url('assets/images', $legal->image)}}" alt="{{$legal->title}}">
                            </a>
                        </div>
